...
exports.getHome = (req, res, next) => res.send(getHomePage(begin, between, headerMain, footer, end));

exports.getNotes = (req, res, next) => res.send(getNotes(begin, between, footer, end));

exports.getLogin = (req, res, next) => res.send(getLogin(begin, between, headerSecond, footerSecond, end));

exports.getLoginErr = (req, res, next) => res.send(getLoginErr(begin, between, headerSecond, footerSecond, end));

exports.getSignup = (req, res, next) => res.send(getSignup(begin, between, headerSecond, footerSecond, end));

exports.getSignupErr = (req, res, next) => res.send(getSignupErr(begin, between, headerSecond, footerSecond, end));

exports.get404 = (req, res, next) => res.send(get404(begin, between, headerMain, footer, end));
